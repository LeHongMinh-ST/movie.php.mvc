...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2021 at 12:11 PM
...
INSERT INTO `categories` (`id`, `name`, `description`, `parent_id`, `user_id`, `slug`) VALUES
(4, 'Phim kinh dị', 'Phim kinh dị', 0, 1, 'phim-kinh-di'),
(5, 'Phim tình cảm', 'Đây là phim tình cảm', 0, 1, 'phim-tinh-cam'),
(7, 'Phim Hoạt hình', 'Đây là tổng hợp phim hoạt hình', 0, 1, 'phim-hoat-hinh'),
(9, 'Doremon truyện ngắn', '', 7, 1, 'Doremon-chuyen-ngan'),
(10, 'Doremon truyện dài', '', 7, 1, 'doremon-truyen-dai');
...
(5, 'Doraemon: Nobita và chuyến phiêu lưu vào xứ quỷ', 7, NULL, 'https://www.youtube.com/embed/MXgutKigxwA', 1);
