        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3">
                ...
                <ul class="footer__app">
                    <li><a href="#"><img src="<?php echo URL?>/publics/frontend/img/Download_on_the_App_Store_Badge.svg" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo URL?>/publics/frontend/img/google-play-badge.png" alt=""></a></li>
                </ul>
            </div>
            <!-- end footer list -->
